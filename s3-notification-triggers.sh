...
bucket_name="akash-ultimate-bucket"
lambda_func_name="akash-s3-lambda-function"
role_name="akash-s3-lambda-sns"
email_address="mathurakash700@gmail.com"
...
topic_arn=$(aws sns create-topic --name akash-s3-lambda-sns --output json | jq -r '.TopicArn')
...
aws sns publish \
  ...
  --message "Hello from Akash Mathur"
